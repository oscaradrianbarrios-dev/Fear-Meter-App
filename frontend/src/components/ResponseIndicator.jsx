...
export const ResponseIndicator = ({
    ...
    const texts = {
        EN: {
            [RESPONSE_TYPE.NONE]: "MONITORING SUBJECT",
            [RESPONSE_TYPE.EXERCISE]: "PHYSICAL ACTIVITY — DATA RECORDING",
            [RESPONSE_TYPE.FEAR]: "FEAR PATTERN IDENTIFIED",
            [RESPONSE_TYPE.STRESS]: "STRESS RESPONSE — NO ESCAPE DETECTED",
            [RESPONSE_TYPE.ANXIETY]: "ANXIETY SIGNATURE — SUBJECT AWARE",
            notCalibrated: "CALIBRATION REQUIRED — SUBJECT UNVERIFIED",
            inactive: "AWAITING SUBJECT",
            calibrated: "SUBJECT CALIBRATED",
            panicSuppressed: "PANIC SUPPRESSED — DATA CONTINUES RECORDING",
        },
        ES: {
            [RESPONSE_TYPE.NONE]: "MONITOREANDO SUJETO",
            [RESPONSE_TYPE.EXERCISE]: "ACTIVIDAD FÍSICA — DATOS REGISTRÁNDOSE",
            [RESPONSE_TYPE.FEAR]: "PATRÓN DE MIEDO IDENTIFICADO",
            [RESPONSE_TYPE.STRESS]: "RESPUESTA DE ESTRÉS — SIN ESCAPE DETECTADO",
            [RESPONSE_TYPE.ANXIETY]: "FIRMA DE ANSIEDAD — SUJETO CONSCIENTE",
            notCalibrated: "CALIBRACIÓN REQUERIDA — SUJETO NO VERIFICADO",
            inactive: "ESPERANDO SUJETO",
            calibrated: "SUJETO CALIBRADO",
            panicSuppressed: "PÁNICO SUPRIMIDO — DATOS CONTINÚAN REGISTRÁNDOSE",
        },
    };
